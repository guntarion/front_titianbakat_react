...
import { avatar02, avatar06, avatar07, avatar08, avatar09, avatar10, blog01, replyIcon } from "../imagepath"
                                                ...
                                                <li>
                                                    <div className="post-author">
                                                        <Link to="/admin/profile">
                                                            <img src={avatar02} alt="Post Author" /> <span>by Dr. Lester </span>
                                                        </Link>
                                                    </div>
                                                </li>
                                                <li>
                                        ...
                                        <div className="about-author">
                                            ...
                                            <div className="author-details">
                                                <Link to="/admin/profile" className="blog-author-name">
                                                    Dr. Darren Elder <span>Orthopaedics, Male, 40 Years Old</span>
                                                </Link>
                                                <p className="mb-0">
                                                ...
                                                <div className="comment">
                                                    ...
                                                    <div className="comment-block">
                                                        ...
                                                        <Link className="comment-btn" to="#">
                                                            <img className="me-1" alt="icon" src={replyIcon} /> Reply
                                                        </Link>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="card-body">
                                        <form>
                                            ...
                                            <div className="form-group">
                                                <textarea rows={4} className="form-control bg-grey" placeholder="Comments" defaultValue={""} />
                                            </div>
