...
const AppRouter = () => {
  ...
  return (
    <Switch>
      ...
      <ProtectedRoute
        path='/asesmen/multipleintelligence'
        component={Asesment103MultipleIntelligence}
      />
      ...
      <ProtectedRoute
        path='/asesmen/personalityelement'
        component={Asesment202PersonalityElement}
      />
      <ProtectedRoute
        path='/asesmen/eneagram'
        component={Asesment203Eneagram}
      />
      <ProtectedRoute
        path='/asesmen/hogwarts'
        component={Asesment204Hogwarts}
      />
      <ProtectedRoute
        path='/asesmen/introekstraversion'
        component={Asesment205IntroEkstraversion}
      />
      <ProtectedRoute
        path='/asesmen/emotionalquotient'
        component={Asesment301EmotionalQuotient}
      />
      <ProtectedRoute
        path='/asesmen/assertive'
        component={Asesment302Assertive}
      />
      <ProtectedRoute path='/asesmen/anxious' component={Asesment303Anxious} />
      <ProtectedRoute
        path='/asesmen/rational'
        component={Asesment304Rational}
      />
      <ProtectedRoute
        path='/asesmen/penundanunda'
        component={Asesment305PenundaNunda}
      />
      <ProtectedRoute
        path='/asesmen/sikapatasuang'
        component={Asesment306SikapAtasUang}
      />
      <ProtectedRoute
        path='/asesmen/ketangguhan'
        component={Asesment307Ketangguhan}
      />
      <ProtectedRoute
