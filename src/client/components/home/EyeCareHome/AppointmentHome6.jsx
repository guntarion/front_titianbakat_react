// src/client/components/home/EyeCareHome/AppointmentHome6.jsx
            ...
            <section className="appointment-section">
                <div className="appointment-form">
                    <div className="container">
                        ...
                        placeholder="Date"
                      /> */}
                                            <DatePicker className="form-control datetimepicker" selected={selectedDate} onChange={handleDateChange} placeholderText="Date" />
                                            <i>
                      ...
                      /> */}
                                            <TimePicker value={selectedTime} onChange={handleTimeChange} className="form-control timepicker1" placeholder="Time" />
                                ...
                                <div className="col-md-12 text-center">
                                    <Link to="/patient/search-doctor1" className="btn btn-light-blue app-btn">
                                        Book an Appointment
                                    </Link>
                                </div>
                            </div>
