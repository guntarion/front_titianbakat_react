// src/client/components/pages/asesmenpage/page_301_emotionalquotient.jsx
import React, { useState, useEffect } from 'react';
import { Link, useHistory } from 'react-router-dom';
import Header from '../../header';
import QuizTypeA from '../../Quiz/quiz-type-a';
import QuizResult from '../../Quiz/Quiz-Result/result_301_emotionalquotient';
...
const Asesment301EmotionalQuotient = (props) => {
  const { user } = useAuth();
        ...
        if (data.mongoUserId) {
          try {
            ...
            const quizInfoResponse = await axios.get(
              `${config.API_URL}/quizzes/quiz_301_emotionalquotient`
            );
            ...
            try {
              const latestInProgressResponse = await axios.get(
                `${config.API_URL}/quiz-responses/${data.mongoUserId}/quiz_301_emotionalquotient/latest-in-progress`
              );
            ...
            try {
              const latestFinishedResponse = await axios.get(
                `${config.API_URL}/quiz-responses/${data.mongoUserId}/quiz_301_emotionalquotient/latest-finished`
              );
  ...
  const startQuiz = async () => {
    try {
      ...
      const url = `${config.API_URL}/quiz-responses/${mongoUserId}/quiz_301_emotionalquotient/latest`;
        ...
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-12'>
              ...
              {showQuiz && (
                <QuizTypeA
                  quizId='quiz_301_emotionalquotient'
...
export default Asesment301EmotionalQuotient;
