// src/client/components/pages/asesmenpage/page_102_riasec.jsx
...
const Asesment102Riasec = props => {
    ...
    const scoreTypes = ["Realistic", "Investigative", "Artistic", "Social", "Enterprising", "Conventional"]
        ...
        const fetchData = async () => {
            ...
            if (docSnap.exists()) {
                ...
                if (data.mongoUserId) {
                    try {
                        // Fetch quiz info
                        const quizInfoResponse = await axios.get(`${config.API_URL}/quizzes/quiz_102_riasec`)
                        setQuizInfo(quizInfoResponse.data)

                        // Fetch latest in-progress quiz response
                        try {
                            const latestInProgressResponse = await axios.get(`${config.API_URL}/quiz-responses/${data.mongoUserId}/quiz_102_riasec/latest-in-progress`)
                        ...
                        try {
                            const latestFinishedResponse = await axios.get(`${config.API_URL}/quiz-responses/${data.mongoUserId}/quiz_102_riasec/latest-finished`)
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-12">
                            {showLatestResult ? (
                                <QuizResult totalScores={totalScores} onBackToIntro={handleBackToIntro} userId={mongoUserId} userEmail={user.email} />
                            ) : (
                                <div>
                                    {!showQuiz && (
                                        <>
                                            ...
                                            <p>
                                                <strong>RIASEC</strong> adalah model yang dikembangkan oleh psikolog John Holland untuk membantu individu memahami kepribadian dan
                                                minat karier mereka. Model ini mengelompokkan orang ke dalam enam tipe kepribadian utama: Realistic, Investigative, Artistic,
                                                Social, Enterprising, dan Conventional. Setiap tipe mencerminkan kecenderungan seseorang terhadap jenis pekerjaan dan lingkungan
                                                kerja tertentu.
                                            </p>
                                            <p>
                                            ...
                                            <ol>
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <strong>Pemilihan Jurusan dan Karier</strong>: Mengetahui tipe RIASEC dapat membantu pelajar memilih jurusan yang sesuai
                                                            dengan minat dan bakat mereka, serta merencanakan karier yang mereka nikmati dan cocok.
                                                        </li>
                                                        <li>
                                                            <strong>Pengembangan Diri</strong>: Pelajar dapat memahami kekuatan dan kelemahan mereka, serta fokus pada pengembangan
                                                            keterampilan yang relevan dengan tipe kepribadian mereka.
                                                        </li>
                                                    </ul>
                                                </li>
                                                <br></br>
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <strong>Kepuasan Kerja</strong>: Memilih pekerjaan yang sesuai dengan tipe RIASEC dapat meningkatkan kepuasan dan
                                                            motivasi kerja, karena pekerjaan tersebut sesuai dengan minat dan kepribadian.
                                                        </li>
                                                        <li>
                                                            <strong>Pengembangan Karier</strong>: Pekerja dapat merencanakan langkah-langkah pengembangan karier yang lebih
                                                            strategis dengan memahami tipe RIASEC mereka.
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ol>
                                            ...
                                            <p>
                                                Asesmen RIASEC terdiri dari sejumlah pertanyaan yang dirancang untuk memberikan hasil yang akurat dan optimal. Kami memahami bahwa
                                                jumlah pertanyaan ini cukup banyak, namun setiap pertanyaan sangat penting untuk memastikan bahwa hasil yang Anda terima benar-benar
                                                mencerminkan kepribadian dan minat Anda.
                                            </p>
                                            <p>
                                                Anda tidak perlu menyelesaikan seluruh asesmen dalam satu sesi. Aplikasi kami memungkinkan Anda untuk menyimpan progres dan
                                                melanjutkan pengisian di lain waktu. Anda dapat membagi pengisian asesmen menjadi beberapa sesi yang lebih pendek sesuai dengan
                                                kenyamanan Anda. Hal ini memastikan bahwa Anda dapat mengisi pertanyaan dengan penuh perhatian tanpa merasa terburu-buru.
                                            </p>
                                            <hr />
                                            <p>
                                            ...
                                            <p>
                                                Siap untuk mengetahui tipe RIASEC Anda? Mulailah asesmen sekarang dan temukan jalur pendidikan dan karier yang paling sesuai dengan
                                                diri Anda. Anda dapat melanjutkan di lain waktu jika perlu. Selamat mengeksplorasi potensi Anda!
                                            </p>
