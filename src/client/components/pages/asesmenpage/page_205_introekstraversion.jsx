// src/client/components/pages/asesmenpage/page_205_introekstraversion.jsx
import React, { useState, useEffect } from 'react';
import { Link, useHistory } from 'react-router-dom';
import Header from '../../header';
import QuizTypeA from '../../Quiz/quiz-type-a';
import QuizResult from '../../Quiz/Quiz-Result/result_205_introekstraversion';
...
const Asesment205IntroEkstraversion = (props) => {
  const { user } = useAuth();
  ...
  const scoreTypes = ['Introversion', 'Ekstraversion'];
        ...
        if (data.mongoUserId) {
          try {
            ...
            const quizInfoResponse = await axios.get(
              `${config.API_URL}/quizzes/quiz_205_introekstraversion`
            );
            ...
            try {
              const latestInProgressResponse = await axios.get(
                `${config.API_URL}/quiz-responses/${data.mongoUserId}/quiz_205_introekstraversion/latest-in-progress`
              );
            ...
            try {
              const latestFinishedResponse = await axios.get(
                `${config.API_URL}/quiz-responses/${data.mongoUserId}/quiz_205_introekstraversion/latest-finished`
              );
  ...
  const startQuiz = async () => {
    try {
      ...
      const url = `${config.API_URL}/quiz-responses/${mongoUserId}/quiz_205_introekstraversion/latest`;
        ...
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-12'>
                ...
                <div>
                  {!showQuiz && (
                    <>
                      ...
                      <p>
                        This assessment will help you identify your preferred
                        learning style. Understanding your learning style can
                        help you choose more effective study methods and improve
              ...
              {showQuiz && (
                <QuizTypeA
                  quizId='quiz_205_introekstraversion'
...
export default Asesment205IntroEkstraversion;
