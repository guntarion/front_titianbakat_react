...
import ChartLearningStyles from "../Quiz-Chart/chart_307_ketangguhan";
...
const QuizResult307Ketangguhan = ({ totalScores, onBackToIntro   }) => {
...
QuizResult307Ketangguhan.propTypes = {
...
export default QuizResult307Ketangguhan;