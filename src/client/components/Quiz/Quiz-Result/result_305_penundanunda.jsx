...
import ChartLearningStyles from "../Quiz-Chart/chart_305_penundanunda";
...
const QuizResult305PenundaNunda = ({ totalScores, onBackToIntro   }) => {
...
QuizResult305PenundaNunda.propTypes = {
...
export default QuizResult305PenundaNunda;