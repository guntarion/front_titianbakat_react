...
import ChartLearningStyles from "../Quiz-Chart/chart_302_assertive";
...
const QuizResult302Assertive = ({ totalScores, onBackToIntro   }) => {
...
QuizResult302Assertive.propTypes = {
...
export default QuizResult302Assertive;