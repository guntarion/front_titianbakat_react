...
import ChartLearningStyles from "../Quiz-Chart/chart_306_sikapatasuang";
...
const QuizResult306SikapAtasUang = ({ totalScores, onBackToIntro   }) => {
...
QuizResult306SikapAtasUang.propTypes = {
...
export default QuizResult306SikapAtasUang;