...
import ChartLearningStyles from "../Quiz-Chart/chart_204_hogwarts";
...
const QuizResult204Hogwarts = ({ totalScores, onBackToIntro   }) => {
...
QuizResult204Hogwarts.propTypes = {
...
export default QuizResult204Hogwarts;