...
import ChartLearningStyles from "../Quiz-Chart/chart_202_personalityelement";
...
const QuizResult202PersonalityElement = ({ totalScores, onBackToIntro   }) => {
...
QuizResult202PersonalityElement.propTypes = {
...
export default QuizResult202PersonalityElement;