...
import ChartLearningStyles from "../Quiz-Chart/chart_203_eneagram";
...
const QuizResult203Eneagram = ({ totalScores, onBackToIntro   }) => {
...
QuizResult203Eneagram.propTypes = {
...
export default QuizResult203Eneagram;