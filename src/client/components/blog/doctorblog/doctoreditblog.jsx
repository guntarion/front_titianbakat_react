// src/client/components/blog/doctorblog/doctoreditblog.jsx
                                        ...
                                        <div className="card-body">
                                            ...
                                            <form method="post" encType="multipart/form-data" autoComplete="off" id="update_service" action="/doctor-blog">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-12">
                                                            <div className="form-group">
                                                                ...
                                                                <textarea id="about" className="form-control service-desc" name="about">
                                                                    note.
                                                                </textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="submit-section">
                                                    <button className="btn btn-primary submit-btn" type="submit" name="form_submit" defaultValue="submit">
                                                        Submit
                                                    </button>
                                                </div>
                                            </form>
