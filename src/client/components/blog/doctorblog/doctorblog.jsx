// src/client/components/blog/doctorblog/doctorblog.jsx
...
const Doctorblog = props => {
    return (
        <div>
                                ...
                                <div className="doc-review review-listing">
                                    <div className="row mb-5">
                                        ...
                                        <div className="col-auto">
                                            <Link className="btn btn-primary btn-sm" to="/blog/doctor-add-blog">
                                    ...
                                    <div className="row blog-grid-row">
                                            ...
                                            <div className="blog grid-blog">
                                                        ...
                                                        <li>
                                                            <div className="post-author">
                                                                <Link to="/patient/doctor-profile">
                                                                    <img src={IMG08} alt="Post Author" /> <span>Dr. Ruby Perrin</span>
                                                                </Link>
                                                            </div>
                                                        </li>
                                                        <li>
                                                ...
                                                <div className="row pt-3">
                                                    ...
                                                    <div className="col text-end">
                                                        <Link to="#" className="text-danger" data-bs-toggle="modal" data-bs-target="#deleteNotConfirmModal">
                                                ...
                                                <div className="blog-content">
                                                    <ul className="entry-meta meta-item">
                                                        <li>
                                                            <div className="post-author">
                                                                <Link to="/patient/doctor-profile">
                                                                    <img src={IMG02} alt="Post Author" /> <span>Dr. Darren Elder</span>
                                                                </Link>
                                                            </div>
                                                        </li>
                                                        <li>
                                                ...
                                                <div className="blog-content">
                                                    <ul className="entry-meta meta-item">
                                                        <li>
                                                            <div className="post-author">
                                                                <Link to="/patient/doctor-profile">
                                                                    <img src={doctorthumb3} alt="Post Author" /> <span>Dr. Deborah Angel</span>
                                                                </Link>
                                                            </div>
                                                        </li>
                                                        <li>
                                        ...
                                        <div className="col-md-6 col-xl-4 col-sm-12">
                                            ...
                                            <div className="blog grid-blog">
                                                <div className="blog-image">
                                                    <Link to="/blog/blog-details">
                                                        <img className="img-fluid" src={blog4} alt="Post Image" />
                                                    </Link>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="entry-meta meta-item">
                                                        <li>
                                                            <div className="post-author">
                                                                <Link to="/patient/doctor-profile">
                                                                    <img src={doctorthumb4} alt="Post Author" /> <span>Dr. Sofia Brient</span>
                                                                </Link>
                                                            </div>
                                                        </li>
                                                        <li>
                                        ...
                                        <div className="col-md-6 col-xl-4 col-sm-12">
                                            ...
                                            <div className="blog grid-blog">
                                                <div className="blog-image">
                                                    <Link to="/blog/blog-details">
                                                        <img className="img-fluid" src={blog5} alt="Post Image" />
                                                    </Link>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="entry-meta meta-item">
                                                        <li>
                                                            <div className="post-author">
                                                                <Link to="/patient/doctor-profile">
                                                                    <img src={doctorthumb5} alt="Post Author" /> <span>Dr. Marvin Campbell</span>
                                                                </Link>
                                                            </div>
                                                        </li>
                                                        <li>
                                                ...
                                                <div className="blog-content">
                                                    <ul className="entry-meta meta-item">
                                                        <li>
                                                            <div className="post-author">
                                                                <Link to="/patient/doctor-profile">
                                                                    <img src={doctorthumb6} alt="Post Author" /> <span>Dr. Katharine Berthold</span>
                                                                </Link>
                                                            </div>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <h3 className="blog-title">
                                                        <Link to="/blog/blog-details">Simple steps to make your doctor visits exceptional!</Link>
                                                    </h3>
                                                    <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                                                </div>
                                                <div className="row pt-3">
                                                ...
                                                <div className="blog-content">
                                                    <ul className="entry-meta meta-item">
                                                        <li>
                                                            <div className="post-author">
                                                                <Link to="/patient/doctor-profile">
                                                                    <img src={doctorthumb7} alt="Post Author" /> <span>Dr. Linda Tobin</span>
                                                                </Link>
                                                            </div>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <h3 className="blog-title">
                                                        <Link to="/blog/blog-details">Choose your own Online Doctor Appointment</Link>
                                                    </h3>
                                                    <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                                                </div>
                                                <div className="row pt-3">
                                                ...
                                                <div className="blog-content">
                                                    <ul className="entry-meta meta-item">
                                                        <li>
                                                            <div className="post-author">
                                                                <Link to="/patient/doctor-profile">
                                                                    <img src={doctorthumb8} alt="Post Author" /> <span>Dr. Paul Richard </span>
                                                                </Link>
                                                            </div>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <h3 className="blog-title">
                                                        <Link to="/blog/blog-details">Simple steps to visit your doctor today</Link>
                                                    </h3>
                                                    <p className="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed do eiusmod tempor.</p>
                                                </div>
                                                <div className="row pt-3">
                                                ...
                                                <div className="blog-content">
                                                    <ul className="entry-meta meta-item">
                                                        <li>
                                                            <div className="post-author">
                                                                <Link to="/patient/doctor-profile">
                                                                    <img src={doctorthumb9} alt="Post Author" /> <span>Dr. John Gibbs</span>
                                                                </Link>
                                                            </div>
                                                        </li>
                                                        <li>
                                        ...
                                        <div className="col-md-6 col-xl-4 col-sm-12">
                                            ...
                                            <div className="blog grid-blog">
                                                <div className="blog-image">
                                                    <Link to="/blog/blog-details">
                                                        <img className="img-fluid" src={blog10} alt="Post Image" />
                                                    </Link>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="entry-meta meta-item">
                                                        <li>
                                                            <div className="post-author">
                                                                <Link to="/patient/doctor-profile">
                                                                    <img src={doctorthumb10} alt="Post Author" /> <span>Dr. Olga Barlow</span>
                                                                </Link>
                                                            </div>
                                                        </li>
                                                        <li>
            ...
            {/* Model */}
            <div className="modal fade" id="deleteConfirmModal" tabIndex={-1} role="dialog" aria-labelledby="deleteConfirmModal" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-danger si_accept_cancel" data-bs-dismiss="modal">
                                Cancel
                            </button>
                        </div>
                    </div>
