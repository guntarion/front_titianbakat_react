                ...
                >
                  ...
                  {(role === 'konselor' || role === 'admin') && (
                    <li
                      className={`has-submenu ${
                        pathnames.includes('/konselor') ? 'active' : ''
                      }`}
                    >
                      <Link
                        to='#'
                  ...
                  {(role === 'user' || role === 'admin') && (
                    <>
                      ...
                      <li
                        className={`has-submenu ${
                          pathnames.includes('/asesmen') ? 'active' : ''
                        }`}
                      >
                        <Link
                          to='#'
                        ...
                        {isSideMenu === 'asesmen' && (
                          <ul className='submenu'>
                            <li
                              className={
                                pathnames.includes('product-asesmen')
                                  ? 'active'
                                  : ''
                              }
                            >
                              <Link to='/page-anda/page-asesmen-one'>
                                Asesmen 1
                              </Link>
                            </li>
                            <li
                            ...
                            >
                              <Link to='/page-anda/page-asesmen-two'>
                                Asesmen 2
                              </Link>
                            </li>
                            <li
                              className={
                                pathnames.includes('product-all')
                                  ? 'active'
                                  : ''
                              }
                            >
                            ...
                            >
                              <Link to='/asesmen/product-description'>
                                Product Description
                              </Link>
                            </li>
                            <li
                            ...
                            >
                              <Link to='/asesmen/product-checkout'>
                                Product Checkout
                              </Link>
                            </li>
                            <li
                            ...
                            >
                              <Link to='/asesmen/payment-success'>
                                Payment Success
                              </Link>
                            </li>
                          </ul>
                  ...
                  {role === 'admin' && (
                    <li
                      className={`has-submenu ${
                        pathnames.includes('/pages') ? 'active' : ''
                      }`}
                    >
                      <Link
                        to='#'
                        ...
                        <ul className='submenu'>
                          ...
                          >
                            <Link
                              to='#0'
                              className={
                                isSideMenu === 'invoices' ? 'subdrop' : ''
                              }
                              onClick={() =>
                                toggleSidebar(
                                  isSideMenu === 'invoices' ? '' : 'invoices'
                                )
                              }
                            >
                              Invoices
