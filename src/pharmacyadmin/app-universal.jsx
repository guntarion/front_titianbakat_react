...
import AddBlogPost from "./components/blog/addblogpost.jsx"
import ListBlogPost from "./components/blog/adminbloglist.jsx"
import EditBlogPost from "./components/blog/editblogpost.jsx"
import ViewBlogPost from "./components/blog/viewblogpost.jsx"
        ...
        <BrowserRouter basename={`${config.publicPath}`}>
            <div className="main-wrapper">
                ...
                <Switch>
                    ...
                    <Route path="/pharmacyadmin/register" exact component={ParmacyRegsiter} />
                    <Route path="/pharmacyadmin/forgotPassword" exact component={ParmacyForgotPassword} />
                    <Route path="/pharmacyadmin/pharmacyLogin" exact component={PharmacyLogin} />
                    <Route path="/pharmacyadmin/categories" exact component={Categories} />
                    <Route path="/pharmacyadmin/add-blogpost" exact component={AddBlogPost} />
                    <Route path="/pharmacyadmin/list-blogpost" exact component={ListBlogPost} />
                    <Route path="/pharmacyadmin/edit-blogpost/:id" exact component={EditBlogPost} />
                    <Route path="/pharmacyadmin/view-blogpost/:id" exact component={ViewBlogPost} />
                    ...
                    <Route path="/pharmacyadmin/product-list" exact component={ProductList} />
                    <Route path="/pharmacyadmin/LatestCustomer" exact component={LatestCustomer} />
                </Switch>
            </div>
        </BrowserRouter>
    )
