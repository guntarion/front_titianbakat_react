...
const RoutesForUser = () => {
  return (
    <Switch>
      ...
      <Route
        path='/user/patientregisterstep-1'
        exact
        component={Patientregisterstepone}
      />
      <Route
        path='/user/patientregisterstep-2'
        exact
        component={Patientregistersteptwo}
      />
      <Route
        path='/user/patientregisterstep-3'
        exact
        component={Patientregisterstepthree}
      />
      <Route
        path='/user/patientregisterstep-4'
        exact
        component={Patientregisterstepfour}
      />
      <Route
        path='/user/patientregisterstep-5'
        exact
